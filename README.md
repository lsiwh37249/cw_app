...
v3 
- 요구사항1 : 오늘 날짜까지의 작업자 수를 집계
- 
- 테이블 구성
- RESULT_TABLE ( 15개 칼럼 )
    - 프로젝트ID | 데이터ID | 작업 상태 | 작업불가여부 | 유효 오브젝트 수 | 최종 오브젝트 수 | 수정 여부 | Worker ID | 작업>자 닉네임 | Checker ID | 검수자 닉네임 | 작업 종료일 | 검수 종료일 | 작업 수정 시간 | CO 모니터링 URL

- 화면(UI) 구성
    - 입력창 : 없음
    - 결과물(table) : Worker ID | 작업자 닉네임 | 작업 수량 | 유효 오브젝트 수 합계 |
